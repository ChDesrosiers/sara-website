...
Pour participer au concours, vous devez choisir l'un des articles dans la liste ci-dessous et le vulgariser. Pour constituer cette liste, nous avons sélectionné les articles de professeurs de l'ÉTS publiés dans les revues de plus grand impact en 2016, pour chaque département.

* *Attention :* les participants ne peuvent pas choisir un article rédigé par leur directeur de de recherche, même si celui-ci se trouve dans la liste.
