...
** {homepage}/fr/guide_redaction[Guide pratique pour l'écriture d'articles scientifiques]
** {homepage}/fr/guide_style[Guide pour améliorer son style d'écriture]
** {homepage}/fr/guide_evaluation[Guide sur comment évaluer des articles scientifiques]
** {homepage}/fr/ressources[Références à diverses ressources (sites Web, livres, articles, etc.) sur ces thèmes]
...
** {homepage}/fr/soumettre_article[Soumettre un article au service d'évaluation]
** {homepage}/fr/demander_aide[Demander de l'aide sur un aspect particulier de sa rédaction]
...
** {homepage}/fr/joindre_equipe[Se joindre à l'équipe d'évaluateurs]
====
