...
** link:/fr/guide_redaction[Guide pratique pour l'écriture d'articles scientifiques]
...
** link:/fr/demander_aide[Demander de l'aide sur un aspect particulier de sa rédaction]
