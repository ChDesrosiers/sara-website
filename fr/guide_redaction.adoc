...
Bien qu'il n'ait pas les problèmes de l'exemple précédent, ce titre renferme beaucoup de mots inutiles. Un meilleur titre est, par exemple, le suivant: 
...
Un bon résumé devrait être une version condensée de l'article, suivant la même structure que l'article et faisant ressortir les points principaux de chacune de ses sections. Les consignes suivantes peuvent être suivies lors de la rédaction du résumé: 
====
...
** Les étapes principale de la méthodologie (e.g., cadre expérimental, approche d'analyse, etc.)
** Les résultats les plus importants de la recherche
